...
class VLMConfig(PretrainedConfig):
    ...
    def __init__(self,llm_model_path = '/scratch/banghao2/projects/Qwen2.5-0.5B-Instruct',
                 vision_model_path = '/scratch/banghao2/projects/siglip-base-patch16-224',
...
if __name__ == '__main__':
    ...
    images_path = '/scratch/.cache/hub/datasets--liuhaotian--LLaVA-CC3M-Pretrain-595K/snapshots/814894e93db9e12a1dee78b9669e20e8606fd590/images'
    data_path = '/scratch/.cache/hub/datasets--liuhaotian--LLaVA-CC3M-Pretrain-595K/snapshots/814894e93db9e12a1dee78b9669e20e8606fd590/chat.json'
    tokenizer = AutoTokenizer.from_pretrained(config.llm_model_path)
    processor = AutoProcessor.from_pretrained(config.vision_model_path)
    output_dir = '/scratch/banghao2/save/pretrain' 
